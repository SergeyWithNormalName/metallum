...
public final class GiLiveAbiTests {
    ...
    private static void testHeaderEncodingAndEpochStamp() {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            require(first.get(LE_INT, 0L) == 1 && first.get(LE_INT, 4L) == 192,
    ...
    private static void testStatsDecodingAndInvariants() {
        try (Arena arena = Arena.ofConfined()) {
            ...
            packet.set(LE_INT, GiLiveLayout.STATS_PADDING_0_OFFSET, 1);
            expectIllegalArgument(() -> GiLiveGpuResources.decodeStats(packet),
                    "nonzero stats padding was accepted");
            packet.set(LE_INT, GiLiveLayout.STATS_PADDING_0_OFFSET, 0);
