...
""";
    ...
    private static String buildSodiumVertexAssignmentReflection(
        ...
        return "    vec3 position = _vert_position + translation;\n"
                    ...
                    + "    uint metallumReflectionAlphaByte = uint(round(_vert_color.a * 255.0));\n"
                    + "    bool metallumReflectionAlphaCarrier = metallumVertexCarrierMaterial\n"
                    + "            && metallumReflectionAlphaByte > 241u\n"
                    + "            && metallumReflectionAlphaByte < 248u;\n"
                    + "    uint metallumReflectionLightByte = uint(round(\n"
                    + "            _vert_tex_light_coord.x * 256.0));\n"
                    + "    bool metallumReflectionMaxLightCode =\n"
                    + "            metallumReflectionLightByte > 240u\n"
                    + "            && metallumReflectionLightByte < 248u;\n"
                    + "    uint metallumReflectionLightFaceCode = metallumReflectionMaxLightCode\n"
                    + "            ? 248u - metallumReflectionLightByte\n"
                    + "            : metallumReflectionLightByte & 7u;\n"
                    + "    bool metallumReflectionLightCarrier = metallumVertexCarrierMaterial\n"
                    + "            && !metallumReflectionAlphaCarrier\n"
                    + "            && metallumReflectionLightFaceCode >= 1u\n"
                    + "            && metallumReflectionLightFaceCode <= 6u;\n"
                    + "    uint metallumReflectionFaceCode = metallumReflectionAlphaCarrier\n"
                    + "            ? 248u - metallumReflectionAlphaByte\n"
                    + "            : metallumReflectionLightCarrier ? metallumReflectionLightFaceCode : 0u;\n"
                    + "    uint metallumReflectionRestoredLightByte = metallumReflectionMaxLightCode\n"
                    + "            ? 248u : metallumReflectionLightByte - metallumReflectionFaceCode;\n"
                    + "    if (metallumReflectionAlphaCarrier) {\n"
                    + "        _vert_color.a = 1.0;\n"
                    + "    } else if (metallumReflectionLightCarrier) {\n"
                    + "        _vert_tex_light_coord.x =\n"
                    + "                float(metallumReflectionRestoredLightByte) / 256.0;\n"
                    + "    }\n"
                    ...
                    + "            && metallumReflectionEnvironment.materialContract.x == 1u\n"
    ...
    private static final String SODIUM_ENVIRONMENT_ACCUMULATION_REFL =
            "    color.rgb += metallumEvaluateEnvironmentV1(\n"
                    ...
                    + "            || metallumSurfaceBase == 3u || metallumSurfaceBase == 4u;\n"
